...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Minecraft server'>;
...
export interface PluginBundleRegistryArtifact
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    downloadOnce: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    fileModifiedAt: Schema.Attribute.DateTime;
    isDir: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface PluginYggdrasilToken extends Struct.CollectionTypeSchema {
  collectionName: 'yggdrasil_tokens';
  info: {
    description: 'Issued Yggdrasil access tokens';
    displayName: 'Yggdrasil Token';
    pluralName: 'tokens';
    singularName: 'token';
  };
  options: {
  ...
  attributes: {
    ...
    clientToken: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 64;
      }>;
