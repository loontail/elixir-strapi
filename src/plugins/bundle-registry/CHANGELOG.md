...
All notable changes to `strapi-plugin-bundle-registry` are documented here.
...
- **`getTranslation` helper** (`admin/src/utils/getTranslation.ts`) — prefixes translation IDs with `bundle-registry.`.
