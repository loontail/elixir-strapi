...
The manifest is written to `public/bundle-registry/builds/:slug/artifacts.json` and served at the public API endpoint:

```
GET /api/bundle-registry/builds/:slug/manifest
```
...
```json
{
  "mods": [
    ...
    },
    {
      ...
      "isDir": false,
      "sha256": "b2c3d4e5f6a1...",
      "url": "http://localhost:1337/bundle-registry/builds/my-pack/files/mods/jei-10.0.0.jar"
    }
  ],
  "config": [
    {
    ...
    },
    {
      ...
      "isDir": false,
      "sha256": "c3d4e5f6a1b2...",
      "url": "http://localhost:1337/bundle-registry/builds/my-pack/files/config/settings.json"
    }
  ],
  "root": [
    {
      ...
      "isDir": false,
      "sha256": "d4e5f6a1b2c3...",
      "url": "http://localhost:1337/bundle-registry/builds/my-pack/files/README.txt"
    }
  ]
}
```
